...
if true
            ...
            * ShapeCfg.Orientation.Theta
            ...
            if true
                ...
                if true
                    ...
                    SensorCfg.Phi=0;
                    SensorCfg.Theta=0;
                    SensorCfg.Shape='NESTED_ARRAYS_sensors_TestCase';
                    SensorCfg.ShapeCfg.nElements=K;
                    SensorCfg.ShapeCfg.ULAs_AngleVEC_DEG=ULAs_AngleVEC_DEG;
    ...
    if true
        ...
        if true
            %% General
            if true
                ScenarioCfg.nSnapshots=nSnapshots;
                %% Physiscs
