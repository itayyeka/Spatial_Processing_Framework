...
elseif strcmpi(ElementCfg.Shape,'NESTED_ARRAYS_sensors')
    ...
    ElementCfg.K1=K1;
    ElementCfg.K2=K2;
    ElementCfg.ArrayLocations=ArrayLocations;
elseif strcmpi(ElementCfg.Shape,'NESTED_ARRAYS_sensors_TestCase')
    %% NESTED_ARRAYS_sensors
    %% Create the ula on the x axis (y,z) = (0,0)
    [...
        ElementCfg.newElements,...
        ElementCfg.Nd_Tilda,...
        ElementCfg.U1,...
        ElementCfg.Nd,...
        ElementCfg.Ns,...
        ...
        ElementCfg.lambda2,...
        ElementCfg.DOF,...
        ElementCfg.DenseArrayGenerator,...
        ElementCfg.SparseArrayGenerator, ...
        ElementCfg.Sparse_mVEC,...
        ElementCfg.Sparse_nVEC,...
        ElementCfg.Dense_mVEC,...
        ElementCfg.Dense_nVEC, ...
        ElementCfg.K1,...
        ElementCfg.K2, ...
        ElementCfg.ArrayLocations ...
        ]=...
        SPF_NESTED_ARRAYS_GenerateSenors(ElementCfg);
    [coArray_POS_VEC] = SPF_NESTED_P2_ResolveVirtualArrayPostions(ElementCfg);
    newElements=mat2cell(coArray_POS_VEC,3,ones(1,size(coArray_POS_VEC,2)));
else
